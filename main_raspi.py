...
sensor = ""
dhtDevice = adafruit_dht.DHT22(board.D22, use_pulseio=True)
...
def start_all():
    ...
    # threading.Thread(target=_start_mqtt).start()
...
window.protocol("WM_DELETE_WINDOW", lambda event: destroy_all())
